...
import (
	...
	"github.com/worldsoop/market-envy/go/market_simulation"
)
...
func main() {
	settings := simulator.NewLoadSettingsConfigFromYaml("./market_simulation/market_dynamics_config.yaml")
	iterations := []simulator.Iteration{&market_simulation.MarketDynamicsIteration{}}
